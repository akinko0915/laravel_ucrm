...
<template>
  ...
  <button @click="searchCustomers" type="button" class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg" data-micromodal-trigger="modal-1" href='javascript:;'>検索する</button>
</template>