                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="customer" id="customer" class="leading-7 text-sm text-gray-600">会員名</label>
                                    ...
                                    <div v-if="props.order[0].status == true" class="p-2 w-full">
                                        <Link as="button" :href="route('purchases.edit', { purchase: props.order[0].id })" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">編集する</Link>
                                    </div>
                                </div>
                            </div> 
                        </section>
